...
const showForm = async (req, res) => {
  console.log("showForm API called");
  try {
    res.render("./task9Views/form", {
      basicDetailsResult: [{}],
    ...
    console.log("Error inside showForm API", error);
  }
};
...
const updateDetailsPage = async (req, res) => {
  ...
  try {
    ...
    res.render("./task9Views/form.ejs", {
      basicDetailsResult,
      educationDetailsResult,
      workExperienceResult,
      knownLanguagesResult,
...
const showUsers = async (req, res) => {
  ...
  try {
    ...
    res.render("./task9Views/users.ejs", { usersData });
  } catch (error) {
    console.log("Error inside showUsers API", error);
  }
};

module.exports = { showForm, createUser, updateDetailsPage, updateUser, showUsers };
